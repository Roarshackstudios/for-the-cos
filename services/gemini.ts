...
5. COMPOSITION: Position the subject such that there is significant vertical buffer above the head (at least 25% of the total image height). Ensure the subject has plenty of "headroom" at the top of the frame for a professional cinematic portrait look. The subject should be grounded but not cramped at the top.
